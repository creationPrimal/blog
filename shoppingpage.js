...
const filtercategoriesdiv = document.querySelector('.filtercategories')

filtermenudiv.addEventListener("click", () => {
  if (filtercategoriesdiv.style.height === '0px' || filtercategoriesdiv.style.height === '') {
    ...
    filtercategoriesdiv.style.height = '0px';
